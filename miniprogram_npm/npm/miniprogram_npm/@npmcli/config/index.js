...
__DEFINE__(1653046641922, function(require, module, exports) {
...
}, function(modId) {var map = {"./type-defs.js":1653046641923,"./nerf-dart.js":1653046641925,"./env-replace.js":1653046641926,"./parse-field.js":1653046641927,"./type-description.js":1653046641928,"./set-envs.js":1653046641929}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1653046641923, function(require, module, exports) {
const nopt = require('nopt')
...
}, function(modId) { var map = {"./umask.js":1653046641924}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1653046641924, function(require, module, exports) {
class Umask {}
const parse = val => {
  if (typeof val === 'string') {
    if (/^0o?[0-7]+$/.test(val)) {
...
__DEFINE__(1653046641925, function(require, module, exports) {
...
__DEFINE__(1653046641926, function(require, module, exports) {
...
__DEFINE__(1653046641927, function(require, module, exports) {
// Parse a field, coercing it to the best type available.
const typeDefs = require('./type-defs.js')
const envReplace = require('./env-replace.js')
...
}, function(modId) { var map = {"./type-defs.js":1653046641923,"./env-replace.js":1653046641926,"./umask.js":1653046641924}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1653046641928, function(require, module, exports) {
...
}, function(modId) { var map = {"./type-defs.js":1653046641923}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1653046641929, function(require, module, exports) {
...
return __REQUIRE__(1653046641922);
})()
//miniprogram-npm-outsideDeps=["walk-up-path","ini","nopt","mkdirp-infer-owner","@npmcli/map-workspaces","read-package-json-fast","proc-log","path","os","util","fs","semver","url"]
